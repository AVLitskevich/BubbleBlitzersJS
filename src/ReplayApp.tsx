  ...
  const handleFileSelect = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onload = (event) => {
      try {
        ...
        setError("Error parsing replay file. Ensure it is a valid .replay or .bin JSON file.");
      }
    };
  ...
  return (
    <div className="flex flex-col h-dvh bg-[#0a0a0a] text-white">
      ...
      <div className="flex-1 min-h-0 relative flex flex-row overflow-hidden">
        ...
        {/* Sidebar Panel */}
        <div className={`transition-all duration-300 ease-in-out bg-[#121212] flex flex-col justify-start relative shrink-0 ${isSidebarOpen ? 'w-64 border-r border-white/10' : 'w-0'}`}>
          <div 
          ...
          <div className={`p-6 w-64 uppercase tracking-widest ${isSidebarOpen ? 'opacity-100' : 'opacity-0'} transition-opacity duration-200`}>
            ...
            <div className="space-y-6 text-sm">
              ...
              <div>
                ...
                <div className="font-mono text-emerald-400">
                  {replay ? `${Math.floor(totalTicks / 60)}s` : '—'}
                </div>
              </div>
            ...
            <div className="absolute inset-0 z-50 bg-black/60 backdrop-blur flex items-center justify-center">
              <div className="bg-[#1a1a1a] border border-white/10 p-8 rounded-2xl max-w-md text-center shadow-2xl">
                ...
                <p className="text-zinc-400 text-sm mb-8 leading-relaxed">
                  Welcome to the Bubble Blitzers replay system. You can review matches to verify fairness and analyze plays.<br/><br/>
